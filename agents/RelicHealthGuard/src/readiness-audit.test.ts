...
const environment = {
  ...
  HEALTH_GUARD_POOLS_JSON: JSON.stringify([{ id: "venus-core-usdt", name: "Venus Core Pool", protocol: "Venus", network: "BNB Chain", debtAsset: "USDT", debtAssetAddress: "0x0000000000000000000000000000000000000001", debtVTokenAddress: "0x0000000000000000000000000000000000000002", comptrollerAddress: "0x0000000000000000000000000000000000000003", debtAssetDecimals: 6 }]),
  MAX_REPAY_BASE_UNITS: "1000000", MINIMUM_BNB_GAS_RESERVE_WEI: "1",
