...
| 4 | Bounded-session signer integration | Code-only signing boundary and private session materialization are implemented; runtime wallet adapter remains to be connected to the scoped session | In progress |
